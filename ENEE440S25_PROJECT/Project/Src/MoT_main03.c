...
extern MoT_core_t device4;	//for demo of how to add a new device
extern MoT_core_t device5;	//for demo of how to add a new device
extern MoT_core_t device6;	//for demo of how to add a new device
extern MoT_core_t device7;	//for demo of how to add a new device
extern MoT_core_t device8;	//for demo of how to add a new device
